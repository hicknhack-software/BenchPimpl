...
class ChainedDeleterPimplRect
		: public ChainedDeleterPimplPoint
{
...
public:
	...
	static std::shared_ptr<ChainedDeleterPimplRect> make_shared(double x, double y, double w, double h);
