...
SharedPimplRect::Implementation::Implementation(double x, double y, double w, double h)
	: SharedPimplPoint::Implementation(x, y)
	, w(w)
	, h(h)
{}

double SharedPimplRect::Implementation::sum() const
{
	return x + y + w + h;
}
...
double SharedPimplRect::width() const
{
	return p<Implementation>()->w;	
}

double SharedPimplRect::height() const
{
	return p<Implementation>()->h;
}

double SharedPimplRect::sum() const
{
